	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h2>Hapus Aktivitas Kuliah Mahasiswa</h2>
			</div>

			<table class="table table-bordered table-condensed" style="width: auto">
				<thead>
					<tr>
						<th>Aktivitas Kuliah</th>
						<th>Feeder</th>
			...
			<form class="form-horizontal" action="{$url_sync}" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="submit" class="btn btn-primary" value="Proses Sinkronisasi Hapus" />
						</div>
					</div>
	...
	<script type="text/javascript">
		$(function(){
			...
			var refreshTable = function(semester) {
				var url = '{site_url('sync_del/kuliah_mahasiswa_data')}/'+semester;
