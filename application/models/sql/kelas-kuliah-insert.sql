...
SELECT
    ...
    nvl(mk.kredit_semester, 0) AS sks_mk,
    nvl(mk.kredit_tatap_muka, 0) AS sks_tm,
    nvl(mk.kredit_praktikum, 0) AS sks_prak,
    nvl(mk.kredit_prak_lapangan, 0) AS sks_prak_lap,
    nvl(mk.kredit_simulasi, 0) AS sks_sim,
